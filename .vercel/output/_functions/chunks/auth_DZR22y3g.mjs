...
import { d as distExports } from './index_Bs0HCuc7.mjs';
import './kv_BGMYywOY.mjs';
...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"2.10.1"}`;
...
var TelemetryEventThrottler = class {
  constructor() {
    __privateAdd$1(this, _TelemetryEventThrottler_instances);
    __privateAdd$1(this, _storageKey, "clerk_telemetry_throttler");
    __privateAdd$1(this, _cacheTtl, DEFAULT_CACHE_TTL_MS);
  }
  isEventThrottled(payload) {
    ...
    const now = Date.now();
    const key = __privateMethod$1(this, _TelemetryEventThrottler_instances, generateKey_fn).call(this, payload);
...
var TelemetryCollector = class {
  constructor(options) {
    __privateAdd$1(this, _TelemetryCollector_instances);
    __privateAdd$1(this, _config);
    __privateAdd$1(this, _eventThrottler);
    __privateAdd$1(this, _metadata, {});
    __privateAdd$1(this, _buffer, []);
    __privateAdd$1(this, _pendingFlush, null);
  ...
  record(event) {
    try {
      const preparedPayload = __privateMethod$1(this, _TelemetryCollector_instances, preparePayload_fn).call(this, event.event, event.payload);
      __privateMethod$1(this, _TelemetryCollector_instances, logEvent_fn).call(this, preparedPayload.event, preparedPayload);
      if (!__privateMethod$1(this, _TelemetryCollector_instances, shouldRecord_fn).call(this, preparedPayload, event.eventSamplingRate)) {
        return;
      }
      __privateGet(this, _buffer).push({ kind: "event", value: preparedPayload });
      __privateMethod$1(this, _TelemetryCollector_instances, scheduleFlush_fn).call(this);
    } catch (error) {
  ...
  recordLog(entry) {
    try {
      if (!__privateMethod$1(this, _TelemetryCollector_instances, shouldRecordLog_fn).call(this, entry)) {
        return;
      }
      ...
      const sdkMetadata = __privateMethod$1(this, _TelemetryCollector_instances, getSDKMetadata_fn).call(this);
      const logData = {
        ...
        payload: __privateMethod$1(this, _TelemetryCollector_instances, sanitizeContext_fn).call(this, entry.context)
      };
...
shouldRecord_fn = function(preparedPayload, eventSamplingRate) {
  return this.isEnabled && !this.isDebug && __privateMethod$1(this, _TelemetryCollector_instances, shouldBeSampled_fn).call(this, preparedPayload, eventSamplingRate);
};
...
scheduleFlush_fn = function() {
  if (typeof window === "undefined") {
    __privateMethod$1(this, _TelemetryCollector_instances, flush_fn).call(this);
    return;
  }
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_bm90YWJsZS1waWdsZXQtNjYuY2xlcmsuYWNjb3VudHMuZGV2JA", "SITE": undefined, "SSR": true};
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_7ukE5PVNbDnJUq7DuawFWCpEMR0F9uxx5V0y85jx0J", CLERK_SIGN_IN_URL: "/sign-in" })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.11.8"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.11.8",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_7ukE5PVNbDnJUq7DuawFWCpEMR0F9uxx5V0y85jx0J", CLERK_SIGN_IN_URL: "/sign-in" }).MODE
  },
  telemetry: {
...
export { AuthError as A, requireAdmin as r };
