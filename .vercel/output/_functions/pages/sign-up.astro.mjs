...
const $$SignUp = createComponent(($$result, $$props, $$slots) => {
  ...
  if (Astro2.url.searchParams.get("role")) {
    ...
    if (role && rolesMap[role]) {
      ...
      return Astro2.redirect(`https://docs.google.com/forms/d/e/1FAIpQLScjKOXG0H6Z3s7fO50m3nFT2N5nLKwqV8_ex_FuLvzWRhGUpg/viewform?usp=pp_url&entry.131527022=${roleName}`);
    }
  }
